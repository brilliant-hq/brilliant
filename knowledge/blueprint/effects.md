...
outerglow(#10B981,o(0.3),blur(16))                         ← outer glow
...
```
al(v,g($spacing.3),pad($spacing.4)) s(300,hug) f[(#FFF)] rd($radius.md) shadow(#000,o(0.04),y(1),blur(2)) shadow(#000,o(0.08),y(8),blur(24)) #elev_card
  t("Elevation",Inter,16,sb) f[(#0F172A)] #elev_title
  t("Two-layer shadow creates realistic depth",Inter,14) s(fill,hug) f[(#64748B)] #elev_desc
```

## Fill-type (inside `f[...]` array)
```
f[(#F1F5F9),(f2,inner(#000,o(0.06),y(1),blur(2)))]         ← inner shadow
f[(#1E1E2E),(f2,glow(#EC4899,o(0.7),blur(8)))]             ← inner glow

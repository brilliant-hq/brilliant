...
When an agent reads elements (a `lookup` search or an export), the elements it gets back flash a brief top-to-bottom scan sweep, so you can see exactly what it is looking at.

...
**Migrating a whole file (plugin path):** the plugin's "Import file to Brilliant" streams every page of a Figma file into a NEW Brilliant project named after the file, one canvas per page, in page order. Two things always come with it:

...
- **Remove from list**: drops the project from your list. It never deletes anything on disk or in the cloud. This works on the **Scratch** sandbox too: home normally always offers a Scratch row, and removing it puts that row away for good. Your scratch work is untouched on disk, and the row comes back if Brilliant ever opens the scratch workspace again (which it does when you have no other project to open).

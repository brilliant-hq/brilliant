...
{id} al(v,pad(2,0,0,0)) s(hug,hug) clip "ClipFrame"
  {id} v(nodes[...curve nodes...,(N,W,H),(N+1,0,H)],edges[...curve edges...,(N-1,N),(N,N+1),(N+1,0)],closed) s(W,H) f[(solid(#hex,0.12))] st[(#hex,1.5,n,n,o)] "Shape"
```
...
```
al(v,g(8),pad(16)) s(hug,hug) f[(#FFFFFF)] st[(#E2E8F0,1)] rd(12) clip shadow(#000000,o(0.06),y(1),blur(3)) shadow(#000000,o(0.04),y(2),blur(8)) "Chart"
  t("Monthly Revenue",Inter,14,sb) f[(#0F172A)] "Title"
  al(h,a(s,e),g(4)) s(hug,120) "Cols"
    ...
    al(v,a(e,c),g(4)) s(hug,fill) "Col"
      r s(24,72) f[(#3B82F6)] rd(3,3,0,0) "Bar"
      t("Feb",Inter,10,m,c) f[(#94A3B8)] "Label"
    al(v,a(e,c),g(4)) s(hug,fill) "Col"
      r s(24,90) f[(#3B82F6)] rd(3,3,0,0) "Bar"
      t("Mar",Inter,10,m,c) f[(#94A3B8)] "Label"
    al(v,a(e,c),g(4)) s(hug,fill) "Col"
      r s(24,65) f[(#3B82F6)] rd(3,3,0,0) "Bar"
      t("Apr",Inter,10,m,c) f[(#94A3B8)] "Label"
```
...
```
al(v,g(16),pad(24)) s(hug,hug) f[(#FFFFFF)] st[(#E2E8F0,1)] rd(16) clip shadow(#000000,o(0.06),y(1),blur(3)) shadow(#000000,o(0.04),y(2),blur(8)) "Chart"
  t("Top Features",Inter,14,sb) f[(#0F172A)] "Title"
  al(v,g(8)) s(hug,hug) "Rows"
    al(h,a(s,c),g(8)) s(hug,hug) "Row"
      t("Search",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      r s(200,20) f[(linear(90,#3B82F6,#2563EB))] rd(0,4,4,0) "Bar"
      t("2,412",Inter,11,b) f[(#3B82F6)] "Val"
    al(h,a(s,c),g(8)) s(hug,hug) "Row"
      t("Filter",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      r s(150,20) f[(#3B82F6)] rd(0,4,4,0) "Bar"
      t("1,800",Inter,11,b) f[(#64748B)] "Val"
    al(h,a(s,c),g(8)) s(hug,hug) "Row"
      t("API",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      r s(38,20) f[(#93C5FD)] rd(0,4,4,0) "Bar"
      t("450",Inter,11,b) f[(#64748B)] "Val"
```
...
```
a1b2c3d4e5f70010 al(v,g(16),pad(24)) s(fill,hug) f[(#FFFFFF)] st[(#E2E8F0,1)] rd(16) clip shadow(#000000,o(0.06),y(1),blur(3)) shadow(#000000,o(0.04),y(2),blur(8)) "Chart"
  a1b2c3d4e5f70011 t("Top Features",Inter,14,sb) f[(#0F172A)] "Title"
  a1b2c3d4e5f70012 al(v,g(8)) s(fill,hug) "Rows"
    a1b2c3d4e5f70013 al(h,a(s,c),g(8)) s(fill,hug) "Row"
      a1b2c3d4e5f70014 t("Search",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      a1b2c3d4e5f70015 al(h) s(fill,20) "Track"
        a1b2c3d4e5f70016 r s(fill:2412,fill) f[(linear(90,#3B82F6,#2563EB))] rd(0,4,4,0) "Bar"
        a1b2c3d4e5f70017 r s(fill:588,fill) "Empty"
      a1b2c3d4e5f70018 t("2,412",Inter,11,b) f[(#3B82F6)] "Val"
    a1b2c3d4e5f70019 al(h,a(s,c),g(8)) s(fill,hug) "Row"
      a1b2c3d4e5f7001a t("Filter",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      a1b2c3d4e5f7001b al(h) s(fill,20) "Track"
        a1b2c3d4e5f7001c r s(fill:1800,fill) f[(#3B82F6)] rd(0,4,4,0) "Bar"
        a1b2c3d4e5f7001d r s(fill:1200,fill) "Empty"
      a1b2c3d4e5f7001e t("1,800",Inter,11,b) f[(#64748B)] "Val"
    a1b2c3d4e5f7001f al(h,a(s,c),g(8)) s(fill,hug) "Row"
      a1b2c3d4e5f70020 t("API",Inter,12,m) s(56,hug) f[(#0F172A)] "Lbl"
      a1b2c3d4e5f70021 al(h) s(fill,20) "Track"
        a1b2c3d4e5f70022 r s(fill:450,fill) f[(#93C5FD)] rd(0,4,4,0) "Bar"
        a1b2c3d4e5f70023 r s(fill:2550,fill) "Empty"
      a1b2c3d4e5f70024 t("450",Inter,11,b) f[(#64748B)] "Val"
```
...
```
al(v,g(12),pad(24)) s(hug,hug) f[(#FFFFFF)] st[(#E2E8F0,1)] rd(16) clip shadow(#000000,o(0.06),y(1),blur(3)) shadow(#000000,o(0.04),y(2),blur(8)) "Chart"
  al(h,a(sb,c)) s(380,hug) "Header"
    t("Revenue Over Time",Inter,14,sb) f[(#0F172A)] "Title"
    al(h,a(s,c),g(16)) s(hug,hug) "Legend"
      al(h,a(s,c),g(4)) s(hug,hug) "LR"
        r s(8,8) f[(#3B82F6)] rd(9999) "Dot"
        t("Revenue",Inter,11,m) f[(#64748B)] "Lbl"
      al(h,a(s,c),g(4)) s(hug,hug) "LP"
        r s(8,8) f[(#10B981)] rd(9999) "Dot"
        t("Profit",Inter,11,m) f[(#64748B)] "Lbl"
  fr s(hug,hug) clip "Body"
    r p(44,0) s(336,1) f[(#F1F5F9)] "G5"
    r p(44,26) s(336,1) f[(#F1F5F9)] "G4"
    r p(44,52) s(336,1) f[(#F1F5F9)] "G3"
    r p(44,78) s(336,1) f[(#F1F5F9)] "G2"
    r p(44,104) s(336,1) f[(#F1F5F9)] "G1"
    r p(44,130) s(336,1) f[(#F1F5F9)] "G0"
    t("$50K",Inter,10,m) p(0,-6) f[(#94A3B8)] "Y5"
    t("$40K",Inter,10,m) p(0,20) f[(#94A3B8)] "Y4"
    t("$30K",Inter,10,m) p(0,46) f[(#94A3B8)] "Y3"
    t("$20K",Inter,10,m) p(0,72) f[(#94A3B8)] "Y2"
    t("$10K",Inter,10,m) p(0,98) f[(#94A3B8)] "Y1"
    t("$0",Inter,10,m) p(0,124) f[(#94A3B8)] "Y0"
    v(nodes[(0,0,104,mi),(1,28,91,mi),(2,56,78,mi),(3,84,65,mi),(4,112,52,mi),(5,140,58,mi),(6,168,46,mi),(7,196,39,mi),(8,224,33,mi),(9,252,26,mi),(10,280,20,mi),(11,308,13,mi),(12,336,7,mi)]) p(44,0) s(336,130) st[(#3B82F6,2)] "Revenue"
    v(nodes[(0,0,117,mi),(1,28,111,mi),(2,56,104,mi),(3,84,98,mi),(4,112,91,mi),(5,140,97,mi),(6,168,85,mi),(7,196,78,mi),(8,224,72,mi),(9,252,65,mi),(10,280,59,mi),(11,308,52,mi),(12,336,39,mi)]) p(44,0) s(336,130) st[(#10B981,2)] "Profit"
  al(h,a(sb,c),pad(0,0,0,44)) s(380,hug) "X Axis"
    t("Jan",Inter,10,m,c) f[(#94A3B8)] "X1"
    t("Mar",Inter,10,m,c) f[(#94A3B8)] "X2"
    t("May",Inter,10,m,c) f[(#94A3B8)] "X3"
    t("Jul",Inter,10,m,c) f[(#94A3B8)] "X4"
    t("Sep",Inter,10,m,c) f[(#94A3B8)] "X5"
    t("Nov",Inter,10,m,c) f[(#94A3B8)] "X6"
```
...
```
    al(v,pad(2,0,0,0)) p(44,0) s(hug,hug) clip "RevClip"
      v(nodes[(0,0,104,mi),(1,28,91,mi),...same curve nodes...,(12,336,7,mi),(13,336,130),(14,0,130)],edges[(0,0,1),(1,1,2),...same curve edges...,(11,11,12),(12,12,13),(13,13,14),(14,14,0)],closed) s(336,130) f[(linear(180,stop(#3B82F6,0,0.12),stop(#3B82F6,1,0)))] st[(#3B82F6,2,n,n,o)] "Revenue"
```
...
```
v(nodes[(0,0,16),(1,10,6),(2,18,20),(3,28,4),(4,38,18),(5,48,8),(6,60,2)]) s(60,24) st[(#EF4444,1.5)] "Sparkline"
```
...
al(v,pad(2,0,0,0)) s(hug,hug) clip "Spark"
  v(nodes[(0,0,22,mi),(1,12,18,mi),(2,28,14,mi),(3,38,17,mi),(4,50,10,mi),(5,60,4,mi),(6,60,24),(7,0,24)],edges[(0,0,1),(1,1,2),(2,2,3),(3,3,4),(4,4,5),(5,5,6),(6,6,7),(7,7,0)],closed) s(60,24) f[(linear(180,stop(#3B82F6,0,0.15),stop(#3B82F6,1,0)))] st[(#3B82F6,1.5,n,n,o)] "Line"
```
...
al(h) s(280,12) rd(9999) clip "Stacked Bar"
  r s(fill:40,fill) f[(#6366F1)] "Segment 1"
  r s(fill:30,fill) f[(#818CF8)] "Segment 2"
  r s(fill:20,fill) f[(#EC4899)] "Segment 3"
  r s(fill:10,fill) f[(#F97316)] "Segment 4"
```
...
al(v,a(c,c),g(8)) s(hug,hug) "Ring"
  gr s(80,80) "Graphic"
    c s(80,80) st[(#E2E8F0,4)] ratio(1) "Track"
    c s(80,80) st[(#3B82F6,4,r,r)] arc(0,75) ratio(1) "Arc"
...
**Progress ring (84%):** `c s(80,80) st[(#3B82F6,4,r,r)] arc(0,84) ratio(1)`
...
| Sweep | Caps | Example |
|-------|------|---------|
| < 80% | Round (`r,r`) | `st[(#3B82F6,4,r,r)] arc(0,75) ratio(1)` |
| 80–90% | Either works | `st[(#3B82F6,4,r,r)] arc(0,84) ratio(1)` |
| > 90% | Flat (omit) | `st[(#3B82F6,4)] arc(0,95) ratio(1)` |

**Gradient progress ring (84%):** `c s(80,80) st[(angular(#3B82F6,#8B5CF6),4,r,r)] arc(0,84) ratio(1)` — angular gradient follows the arc naturally.

**Pie sector (25%):** `c s(80,80) f[(#3B82F6)] arc(0,25)`

**Donut sector (50%):** `c s(80,80) f[(#FF6B35)] arc(0,50) ratio(0.5)`

**Full donut ring:** `c s(80,80) f[(#3B82F6)] ratio(0.5)`

**Starting at 90° (3 o'clock):** `c s(80,80) st[(#10B981,4,r,r)] arc(90,50) ratio(1)`
...
al(v,a(c,c),g(8)) s(hug,hug) "Ring Card"
  gr s(80,80) "Graphic"
    c s(80,80) st[(#E2E8F0,5)] ratio(1) "Track Outer"
    c s(80,80) st[(#3B82F6,5,r,r)] arc(0,78) ratio(1) "Outer"
    c p(12,12) s(56,56) st[(#E2E8F0,4)] ratio(1) "Track Inner"
    c p(12,12) s(56,56) st[(#10B981,4,r,r)] arc(0,62) ratio(1) "Inner"
    t("78%",Inter,14,b,c) p(0,30) s(80,20) f[(#0F172A)] "Pct"
  t("Completion",Inter,11,m,c) f[(#64748B)] "Label"
```

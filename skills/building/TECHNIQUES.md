...
Navbar    f[(f1,#FFFFFF)]
Hero      f[(f1,#FFFFFF)]
Logos     f[(f1,#FAFAFA)]     ← tinted (zinc-50)
Features  f[(f1,#FFFFFF)]
Stats     f[(f1,#F4F4F5)]     ← deeper tint (zinc-100)
Pricing   f[(f1,#FFFFFF)]
CTA       f[(f1,#18181B)]     ← dark accent
Footer    f[(f1,#FAFAFA)]
```
...
```
al(v,a(c,c),g(24),pad(80,64)) s(1280,500) f[(f1,#18181B)] "Dark Section"
  t("Built for scale",Inter,40,sb,c) f[(f1,#FAFAFA)] "Title"
  t("Enterprise-grade from day one.",Inter,16,c) s(600,hug) f[(f1,#A1A1AA)] "Subtitle"
```

**Gradient sweep:** Angle `180` grounds, `135` energizes, `0` lifts. Keep stops in the same tonal family.

```
al(v,a(c,c),g(24),pad(80,64)) s(1280,500) f[(f1,linear(180,#1C1917,#292524))] "Gradient Section"
  t("Ship faster",Inter,40,sb,c) f[(f1,#F5F5F4)] "Title"
  t("From idea to production in minutes.",Inter,16,c) s(600,hug) f[(f1,#A8A29E)] "Subtitle"
```
...
al(v,a(c,c),g(4)) s(hug,hug) "Title"
  al(h,a(c,c),g(10)) s(hug,hug) "Row 1"
    t("We Take Your",Playfair Display,40,b) f[(f1,#1C1917)] "T1"
    al(h,a(c,c)) s(44,44) f[(f1,#EFF6FF)] rd(12) "Ic"
      svg(icon:envelope-simple) s(24,24) st[(s1,#3B82F6,2)] "Icon"
    t("Email",Playfair Display,40,b) f[(f1,#3B82F6)] "T2"
  t("Marketing to the Next Level",Playfair Display,40) italic f[(f1,#1C1917)] "Row 2"
```
...
al(v,g(12)) s(800,hug) "Bento"
  al(h,g(12)) s(fill,hug) "Row 1"
    al(v,g(16),pad(32)) s(fill,hug) f[(f1,#171717)] rd(16) "Wide"
      t("Ship faster",Inter,28,b) s(fill,hug) f[(f1,#FAFAFA)] "Title"
      t("From idea to production in minutes.",Inter,15) s(fill,hug) f[(f1,#A3A3A3)] "Desc"
    al(v,a(c,c)) s(200,200) f[(f1,#EFF6FF)] rd(16) "Square"
      svg(icon:rocket) s(48,48) st[(s1,#3B82F6,2)] "Icon"
  al(h,g(12)) s(fill,hug) "Row 2"
    al(v,a(c,c)) s(200,200) f[(f1,#F0FDF4)] rd(16) "Square"
      svg(icon:shield) s(48,48) st[(s1,#10B981,2)] "Icon"
    al(v,g(12),pad(24)) s(fill,200) f[(f1,#F5F3FF)] rd(16) "Tall"
```
...
gr s(600,400) "Showcase"
  al(v,pad(24)) rot(-4) p(80,50) s(260,hug) f[(f1,#FFFFFF)] st[(s1,#E2E8F0,1)] rd(16) "Back"
  al(v,pad(24)) rot(2) p(60,35) s(260,hug) f[(f1,#FFFFFF)] st[(s1,#E2E8F0,1)] rd(16) "Mid"
  al(v,pad(24)) rot(-1) p(40,20) s(260,hug) f[(f1,#FFFFFF)] st[(s1,#E2E8F0,1)] rd(16) "Front"
```
...
```
fr s(1280,600) f[(f1,img(https://picsum.photos/id/164/1280/600)),(f2,solid(#09090B,0.55))] "Visual"
  al(v,a(c,c),g(20),pad(80,200)) s(fill,fill) "Content"
    t("Your headline here",Inter,48,b,c) s(fill,hug) f[(f1,#FFFFFF)] "Title"
```
...
gr s(800,400) "Section"
  t("DESIGN",Inter,180,bl) p(60,-20) f[(f1,solid(#18181B,0.04))] "Watermark"
  al(v,a(c,c),g(24),pad(60)) s(fill,fill) "Content"
    t("Our Philosophy",Inter,36,b,c) f[(f1,#18181B)] "Title"
```

**Opacity on fill:** `f[(f1,solid(#hex,0.04))]` — always use `solid()` for low-opacity fills.
...
> ```
> al(h,a(c,c),pad(12,24)) s(hug,hug) f[(f1,#18181B)] st[(s1,steel(#FFD700,#DAA520,speed(1.5)),2)] rd(10) "Button"
>   t("Premium",Inter,14,sb) f[(f1,#FAFAFA)] "Label"
> ```
...
> ```
> fr s(900,540) f[(f1,linear(135,#0A0A1A,#1A1040)),(f2,holo(#E879F9,#818CF8,#34D399,opacity(0.12),scale(1.5),speed(0.3)))] clip "Hero"
>   al(v) s(fill,fill) "Page"
>     al(h,a(sb,c),pad(14,28)) s(fill,hug) "Nav"
>       t("acme",Space Grotesk,18,b) f[(f1,#FAFAFA)] "Logo"
>       al(h,a(c,c),g(20)) s(hug,hug) "Links"
>         t("Features",Inter,13,m) f[(f1,solid(#FAFAFA,0.50))] "L1"
>         t("Pricing",Inter,13,m) f[(f1,solid(#FAFAFA,0.50))] "L2"
>       al(h,a(c,c),pad(3)) s(hug,hug) f[(f1,solid(#FFF,0.06))] st[(s1,solid(#FFF,0.08),1)] rd(9999) "Mode"
>         al(h,a(c,c),pad(4,10)) s(hug,hug) rd(9999) "Off"
>           t("Light",Inter,11,m) f[(f1,solid(#FFF,0.35))] "Lbl"
>         al(h,a(c,c),pad(4,10)) s(hug,hug) f[(f1,solid(#FFF,0.12))] rd(9999) "On"
>           t("Dark",Inter,11,sb) f[(f1,#FAFAFA)] "Lbl"
>     al(v,a(c,c)) s(fill,fill) "Center"
>       al(v,a(c,c),g(24),pad(48,64)) s(520,hug) f[(f1,solid(#09090B,0.50)),(f2,blur(16))] rd(24) st[(s1,solid(#FFF,0.08),1)] "Glass"
>         t("Design at the\nspeed of thought",Space Grotesk,38,m,c) f[(f1,#FAFAFA)] "Title"
>         t("Ship polished interfaces in minutes.",Inter,15,c) s(fill,hug) f[(f1,#94A3B8)] "Sub"
>         al(h,a(c,c),pad(12,28)) s(hug,hug) f[(f1,#FAFAFA)] rd(9999) "CTA"
>           t("Start building",Inter,14,sb) f[(f1,#18181B)] "Lbl"
> ```
...
> ```
> al(v,g(12),pad(24)) s(320,hug) f[(f1,#1C1917),(f2,steel(opacity(0.12)))] rd(16) "Card"
>   t("Enterprise Plan",Inter,18,sb) f[(f1,#F5F5F4)] "Title"
>   t("Unlimited seats, priority support.",Inter,14) s(fill,hug) f[(f1,#94A3B8)] "Desc"
> ```
...
>   r s(4,48) f[(f1,metaballs(#F59E0B,#EF4444,#EC4899))] rd(2) "Bar"
>   al(v,g(4)) s(hug,hug) "Text"
>     t("What's New",Inter,20,sb) f[(f1,#171717)] "Title"
>     t("Latest features and improvements",Inter,14) f[(f1,#64748B)] "Sub"
> ```
...
- **Recessed well** (inputs, sunken panels): `f[(f1,#F1F5F9),(f2,inner(#000,0.15,0,1,3))]` — solid fill + subtle dark inset. Great for search bars, text inputs, content wells.
- **Neumorphic press** (toggles, active states): `f[(f1,#E2E8F0),(f2,inner(#000,0.2,2,2,4)),(f3,inner(#FFF,0.7,-2,-2,4))]` — dark bottom-right + light top-left = the surface appears pressed in from one direction.
...
- **Neon edge** (luminous emphasis): `f[(f1,#1E1E2E),(f2,glow(#3B82F6,0.7,8))]` — colored glow on dark fill. The element appears to emit light from within.
- **Soft inner light** (subtle depth): `f[(f1,#1A1A2E),(f2,glow(#FFF,0.15,12))]` — white glow creates gentle inner illumination, an alternative to borders for defining edges on dark surfaces.
...
- **Edge** (thin stroke or inner glow) — defines where glass ends. Real glass refracts light at its edges. `st[(s1,solid(#FFF,0.08-0.20),1)]` or `glow(#FFF,0.08,6)` for soft edge catch.
...
**Tuning:** Start with `f[(f1,solid(#FFF,0.10)),(f2,blur(12))] st[(s1,solid(#FFF,0.12),1)]` and adjust: increase tint opacity for readability, increase blur for more frosting, add `glow()` for edge definition on dark backgrounds. Always verify text contrast.
...
- `f[(f1,metaballs(#09090B,#3B82F6,#8B5CF6,#06B6D4))]` — vibrant brand palette, bold organic motion.
- `f[(f1,metaballs(#F59E0B,#EF4444,count(6),size(0.9)))]` — warm amber-red, fewer blobs for a polished, graphic look.
- `f[(f1,metaballs(#0A0A0A,#064E3B,#065F46,speed(0.3)))]` — near-black + dark emerald, slow = atmospheric forest.
...
- `f[(f1,metal())]` — default silver chrome. Clean metallic surface for hero accents or product showcases.
- `f[(f1,metal(#FFD700,#FFF8DC))]` — warm gold tones. Pair with dark backgrounds for maximum contrast.
- `f[(f1,metal(softness(0.3),repetition(5),contour(0.7)))]` — brushed-metal look with visible striations.
...
- **Text legibility:** Metal fills are extremely busy — never put text on them. Use on strokes, accents, or dividers. For buttons: `f[(f1,#18181B)] st[(s1,metal(),2)]` so text sits on the solid fill.
...
- `f[(f1,holo())]` — default white/lavender palette with rainbow reflections. Instant holographic foil.
- `f[(f1,holo(#FF00FF,#00FFFF,#FFFF00))]` — custom colors shift the iridescence to match brand.
- `f[(f1,holo(intensity(0.4),metallic(0.9),speed(0.2)))]` — restrained: sophisticated shimmer, not full rainbow.
...
- **Text legibility:** Holo fills shift between light and dark — no text color works. Use on strokes (`st[(s1,holo(),2)]`) or as low-opacity texture (`holo(opacity(0.15))`) under a solid fill.
...
- `f[(f1,steel())]` — default flowing chrome. Smooth, professional metallic surface.
- `f[(f1,steel(roughness(0.7),distortion(0.8)))]` — worked-metal look with more surface variation.
- `f[(f1,steel(depth(0.9),flow(0.8),speed(0.3)))]` — deep reflections + high flow + slow = dramatic, mesmerizing.
...
- Example: `f[(f1,metal(shape(circle),scale(1.5),uvrot(30),frozen))]`

**Multi-Fill Stacking** — layer multiple fills: `f[(f1,#F8FAFC),(f2,solid(#3B82F6,0.04))]`. Each fill renders in ID order. Use opacity to let lower layers show through.
...
- **Liquid metal border**: `st[(s1,metal(),2)]` — chrome-reflective edge. The stroke alone makes an element feel expensive.
- **Holographic border**: `st[(s1,holo(intensity(0.5),speed(0.3)),2)]` — rainbow shimmer around any shape. Incredible on dark backgrounds.
- **Gradient stroke**: `st[(s1,linear(90,#3B82F6,#8B5CF6),2)]` — color flows along the stroke. Great for card accents and dividers.
- **Angular gradient stroke**: `st[(s1,angular(#3B82F6,#8B5CF6),2)]` — color sweeps around the shape. The natural choice for progress rings, circular indicators, and badges.
- **Fill-less button**: No fill, just a shader stroke — `st[(s1,metal(softness(0.4)),2)]` on a button frame. The entire visual is the border.
- **Shader stroke + solid fill**: `f[(f1,#18181B)] st[(s1,holo(intensity(0.3),metallic(0.8)),1.5,_,_,i)]` — inside stroke position (`i`) keeps the shader border tight against the fill.

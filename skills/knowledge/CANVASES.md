...
- Enter to rename, Delete to delete
...
|--------|---------------|
| Export canvas | Command palette: "Save as Sketch File" |
| Export folder | Right-click folder in explorer, select "Save as Sketch File" |
...
**Contents:** Element properties, hierarchy, canvas metadata, embedded images (deduplicated).

...
- Standard text editing shortcuts work (Cmd+A, Cmd+C, etc.)
...
Brilliant bundles **245+ curated Google Fonts** plus all **system fonts** from your OS:

| Category | Examples |
|----------|----------|
| **Sans-Serif** (~55) | Inter, Roboto, Poppins, Montserrat, Open Sans, Lato, DM Sans |
| **Serif** (~45) | Playfair Display, Merriweather, Lora, Crimson Text, Source Serif |
...
Set text alignment via the right toolbar Typography section or AI commands ("align text left/center/right"). No default keyboard shortcuts are assigned — use the command palette or the Shortcuts panel (Shift+?) to assign custom keybindings.
